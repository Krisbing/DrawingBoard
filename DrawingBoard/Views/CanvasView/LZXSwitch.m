...
static const CGFloat kLZXSwitchAnimationDuration = 0.25;
...
@synthesize maskedTrackView = _maskedTrackView;
@synthesize maskedThumbView = _maskedThumbView;

@synthesize trackMaskLayer = _trackMaskLayer;
@synthesize onTrackMaskImage = _onTrackMaskImage;
@synthesize offTrackMaskImage = _offTrackMaskImage;
...
- (void)updateThumbPositionAnimated:(BOOL)animated
{
    ...
    if (animated) {
        ...
        CGFloat animationDuration = kLZXSwitchAnimationDuration * distanceOfTravel;
